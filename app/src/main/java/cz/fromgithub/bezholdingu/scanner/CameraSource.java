...
/*
    public Size getPreviewSize() {
        if (mCamera == null)
            return null;
        CameraSource.SizePair sizePair = selectSizePair(mCamera, mRequestedPreviewWidth, mRequestedPreviewHeight);
        if (sizePair == null) {
            throw new RuntimeException("Could not find suitable preview size.");
        }
        Size pictureSize = sizePair.pictureSize();
        Size mPreviewSizeLocal = sizePair.previewSize();

        return mPreviewSizeLocal;
    }
*/
    /**
